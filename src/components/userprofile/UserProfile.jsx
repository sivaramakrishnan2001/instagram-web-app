        ...
        return (
            <div className='user-profilepage'>
                ...
                <div className="content">
                    <div className="tabs">
                        <div className="tab">
                            <div className="icon"><svg aria-label="Posts" className={"svg "} color="#0095f6" fill="#0095f6" height="24" role="img" viewBox="0 0 24 24" width="24">
                        ...
                        <div className="tab">
                            <div className="icon">
                                <svg aria-label="Reels" className={"svg "} color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
